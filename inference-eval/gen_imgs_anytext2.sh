...
# ========== 基础路径配置 ==========
BASE_OUTPUT_DIR="/home/610-zzy/Test-Image"  # 基础输出目录
CKPT_PATH="/home/610-zzy/AnyText2-main-Real0922-DoubleStage-FHS-4/checkpoints/lightning_logs/version_1/checkpoints/epoch=24-step=900.ckpt"  # 模型检查点路径
INPUT_JSON="/home/610-zzy/AnyText2-main-Real0922-DoubleStage-FHS-4/test-result/poem_info_test.json"  # 输入 JSON 文件路径
